...
export default function HomeBrandCTA() {
  return (
    <section className="py-[200px] text-center relative overflow-hidden">
      <div
        className="absolute inset-0"
        style={{ backgroundImage: "url('/images/home/brandCTA_bg.png')", backgroundSize: "cover", backgroundPosition: "center" }}
      />
      <div className="relative z-10 max-w-[1400px] mx-auto px-[60px]">
        <h2 className="text-[54px] font-bold text-title mb-6 max-w-[788px] mx-auto leading-tight">
          從浩瀚海洋到日常生活，
          <br />
          欣展用專業與您同行。
        </h2>
        <p className="text-body text-[22px] mb-10 max-w-[748px] mx-auto leading-relaxed">
