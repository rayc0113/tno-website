...
export default function HomeHero() {
  return (
    <section className="relative h-[80vh] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-[60px] pt-[20vh] md:pt-[22vh]">
        <h1 className="text-[36px] leading-[46px] md:text-[60px] font-extrabold md:leading-[75px] text-white mb-4 max-w-[771px]">
          從材料到設計製造
          <br />
          船舶裝修全方位領導品牌
        </h1>
        <p className="text-white text-base md:text-[20px] md:leading-[30px] mb-8 md:mb-[60px] max-w-[722px]">
