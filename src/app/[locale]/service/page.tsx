...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: { "zh-TW": "/zh/service", "en": "/en/service", "x-default": "/zh/service" },
    },
    ...
    openGraph: {
      ...
      description: t("description"),
      url: `/${locale}/service`,
      images: [{ url: "/images/service/hero.webp", width: 1200, height: 630, alt: t("title") }],
    },
    twitter: {
      card: "summary_large_image",
      title: t("title"),
      description: t("description"),
      images: ["/images/service/hero.webp"],
    },
  };
}
