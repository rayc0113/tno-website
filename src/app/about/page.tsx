...
export default function AboutPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative h-[480px] md:h-[800px] bg-black overflow-hidden">
        <Image
      ...
      <section className="bg-white py-16 md:pt-[140px] md:pb-[140px]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[60px]">
          ...
          <p className="text-body text-base md:text-[20px] text-center leading-[1.8] mb-10 md:mb-[64px] max-w-[988px] mx-auto">
          ...
          {/* Two images */}
          <div className="flex flex-col md:flex-row h-auto md:h-[512px] gap-1">
            <div className="relative h-[240px] md:h-auto flex-1 rounded-tl-[24px] rounded-tr-[24px] md:rounded-tr-none md:rounded-bl-[24px] overflow-hidden">
              <Image
            ...
            <div className="relative h-[240px] md:h-auto md:w-[594px] flex-shrink-0 rounded-bl-[24px] rounded-br-[24px] md:rounded-bl-none md:rounded-tr-[24px] overflow-hidden">
              <Image
      ...
      <section className="bg-white py-16 md:py-[120px]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[60px] flex flex-col md:flex-row md:items-start gap-10 md:gap-0">
          {/* Left: text */}
          <div className="flex-1 flex flex-col md:pt-[27px] md:pr-10">
            <p className="text-brand text-base md:text-[20px] font-semibold mb-3 md:mb-4">我們的信念</p>
            <h2 className="text-[28px] md:text-[40px] font-bold text-title leading-tight mb-4 md:mb-6">
              安全，是家的延伸
            </h2>
            <p className="text-body text-base md:text-[20px] leading-[1.8]">
      ...
      {/* 我們的專業 */}
      <section className="bg-white py-16 md:py-[120px]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[60px] flex flex-col-reverse md:flex-row md:items-start gap-10 md:gap-0">
          ...
          <div className="flex-1 flex flex-col md:pt-[27px] md:pl-10">
            <p className="text-brand text-base md:text-[20px] font-semibold mb-3 md:mb-4">我們的專業</p>
            <h2 className="text-[28px] md:text-[40px] font-bold text-title leading-tight mb-4 md:mb-6">
              專注船舶艙室<br />
              整體規劃與維修服務
            </h2>
      ...
      <section className="bg-white py-16 md:py-[120px]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[60px]">
          <div className="text-center mb-10 md:mb-[80px]">
            ...
            <p className="text-body text-base md:text-[20px] leading-[1.8] max-w-[720px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:gap-[160px] items-start gap-10">
            {/* Left: ISO cert */}
            <div className="flex flex-col items-center flex-shrink-0">
              ...
              <p className="text-body text-sm md:text-[16px] text-center mt-4 leading-relaxed">
            ...
            <div className="flex-1 flex flex-col w-full">
              ...
              <p className="text-body text-sm md:text-[16px] mt-4 leading-relaxed">
