...
const deckFittings: Product = {
  slug: "deck-fittings",
  name: "滾子導索器、萬象輸座",
  nameEn: "Roller Fairleads & Universal Fairlead Pedestals",
  category: "造船用甲板上艤品、錨座配件",
  shortDescription: "完整的甲板上艤品系列，符合國際規範，確保甲板作業安全",
  shortDescriptionEn:
    "A complete range of marine deck outfittings built to international standards for safe deck operations.",
  description:
  ...
  specsEn: [
    { label: "Material", value: "High-strength carbon steel / 316L stainless steel" },
    { label: "Surface Finish", value: "Hot-dip galvanizing / Epoxy coating" },
    { label: "Design Standards", value: "To IACS and IMO standards" },
    { label: "Applicability", value: "Decks of all commercial vessel classes" },
  ...
  featuresEn: [
    "Compliant with IACS and IMO international standards",
    "High-strength materials resistant to marine corrosion",
    "Precision cast or forged with tight dimensional tolerances",
