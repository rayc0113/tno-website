 ...
 *   coverImage / images                    ← 換成 /images/products/handrail-installation-cover.webp 等
 *
...
const handrailInstallation: Product = {
  ...
  coverImage: "/images/products/handrail-installation-cover.webp",
  images: [
    "/images/products/handrail-installation-cover.webp",
    "/images/products/handrail-installation-1.webp",
  ],
  specs: [
